...
public final class AppInfoUseCase extends UseCase {
    ...
    @Inject
    protected AppInfoUseCase(AppInfoRepository appInfoRepository, ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread) {
        super(threadExecutor, postExecutionThread);
        this.mAppInfoRepository = appInfoRepository;
    }

    @Override
    protected Observable<List<AppInfo>> buildUseCaseObservable() {
